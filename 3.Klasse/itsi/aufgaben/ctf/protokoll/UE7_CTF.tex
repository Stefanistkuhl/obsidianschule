...
\end{figure}\abc
Then navigate to the line starting with \texttt{linux} and append \texttt{rw init=/bin/bash}, as shown in Figure 34, to change a kernel parameter. After pressing F10, you will immediately boot into the system with a root shell.
\begin{figure}[h]
