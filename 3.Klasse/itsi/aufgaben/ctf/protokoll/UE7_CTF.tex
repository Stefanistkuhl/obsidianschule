...
\end{figure}\abc
Luckily, as seen in Figure 17, it appears that the webserver has been started as the current user, which we can further inspect with \texttt{ps aux | grep python}. As shown in Figure 18, the process has been started by the root user as GrumpyCat.
\begin{figure}[h]
