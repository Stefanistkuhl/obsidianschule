...
function requireNative() {
  if (process.platform === 'android') {
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        try {
        return require('./typst-ts-node-compiler.linux-arm-musleabihf.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        return require('@myriaddreamin/typst-ts-node-compiler-linux-arm-musleabihf')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('./typst-ts-node-compiler.linux-ppc64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        return require('@myriaddreamin/typst-ts-node-compiler-linux-ppc64-gnu')
      } catch (e) {
        loadErrors.push(e)
      }
...
module.exports.NodeHtmlOutput = nativeBinding.NodeHtmlOutput
module.exports.NodeHtmlOutputExecResult = nativeBinding.NodeHtmlOutputExecResult
...
module.exports.NodeTypstProject = nativeBinding.NodeTypstProject
module.exports.ProjectWatcher = nativeBinding.ProjectWatcher
