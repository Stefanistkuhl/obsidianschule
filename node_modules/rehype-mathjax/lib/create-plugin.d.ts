 ...
 *   Plugin.
 */
export function createPlugin(createRenderer: CreateRenderer): (options?: Readonly<Options> | null | undefined) => (tree: Root, file: VFile) => undefined;
/**
 * Create a renderer.
 */
 ...
 */
export type MathNotation = [open: string, close: string];
/**
 * Configuration.
 *
 * ###### Notes
